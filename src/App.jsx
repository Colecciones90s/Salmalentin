...
function App() {
    ...
    ,
  {
    ...
    img: "https://i.gifer.com/Mpbx.gif"
  },
  {
    id: 3,
        ...
        !valueSi ? (
          <div className="p-5">
            ...
            <img src={Object.keys(randomValor).length === 0 ?
              "https://i.pinimg.com/originals/cd/c1/31/cdc131bd280551132d41924e86973599.gif" : randomValor.img} alt="San Valentin" className="mx-auto" width={400} height={400} />
          ...
          <div className="flex justify-center items-center flex-col space-y-10">
            <h1 className="text-4xl text-white font-bold color_texto">Sabia que dirias que si 🌻❤️🌻 vamos por un heladito!</h1>
            <img src="https://i.pinimg.com/originals/9b/dc/c6/9bdcc6206c1d36a37149d31108c6bb41.gif" alt="" className="mx-auto" />
            <span hidden>{document.title = 'Sabia que dirias que si 🌻❤️🌻 vamos por un heladito!'}</span>
          </div>
        )
      }
    </main>
